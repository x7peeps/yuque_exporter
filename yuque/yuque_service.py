...
hostUrl = "https://yourrepo.yuque.com" #想要下载的空间
...
def getMarkDownFileExport(blog_id_dict: {}):
    ...
    for blog_id, blog_index in blog_id_dict.items():
        ...
        markdown_file_export = hostUrl+"/api/docs/" + str(blog_id) + "/export"
...
def publish_blog(blog_id_list: []):
    for blog_id in blog_id_list:
        ...
        markdown_file_export = hostUrl+"/api/docs/" + str(blog_id) + "/publish"
...
def get_lib_dict():
    ...
    url = hostUrl+"/api/mine/common_used?"
